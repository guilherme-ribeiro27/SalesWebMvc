...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(2, "Maria Green", "maria@gmail.com", new DateTime(1979, 4, 25), 3100.0, d1);
            Seller s3 = new Seller(3, "Alex Grey", "alex@gmail.com", new DateTime(1995, 7, 3), 1500.0, d2);
            Seller s4 = new Seller(4, "Martha Red", "martha@gmail.com", new DateTime(1960, 4, 21), 5000.0, d3);
            Seller s5 = new Seller(5, "Donald Blue", "donald@gmail.com", new DateTime(2000, 10, 25), 1900.0, d4);
            Seller s6 = new Seller(6, "Alex Pink", "alex@gmail.com", new DateTime(1987, 8, 28), 2000.0, d4);
